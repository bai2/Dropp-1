...
function create_table() {
	...
	for (var i = 0; i < len; i++) {
		emotes_list.push("<td style='background: #A2C7EE; border-radius: 5px; text-align: center; font-family: sans-serif; border: 1px solid #303B78; padding: 5px;'>" +
			"<img src='" + emotes[emotes_name[i]] + "'' title='" + emotes_name[i] + "' height='' width='' />" +
			emotes_name[i] + "</td>");
	}
	...
	return "<div class='infobox'><div class = 'infobox'><center><b><u>Lista de emoticones del Servidor</u></b></center>" + "<div class='infobox-limited'><table cellspacing='0' cellpadding='5' width='100%'>" + "<tbody>" + emotes_group_list.join("") + "</tbody>" + "</table></div></div>";
} 
...
exports.commands = {
	...
	emoticonshelp: ["/emoticons - Obten la lista de Emoticones."],
